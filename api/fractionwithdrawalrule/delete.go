...
func (s *Server) DeleteFractionWithdrawalRule(ctx context.Context, in *npool.DeleteFractionWithdrawalRuleRequest) (*npool.DeleteFractionWithdrawalRuleResponse, error) {
	if in.GetInfo() == nil {
		...
		return &npool.DeleteFractionWithdrawalRuleResponse{}, status.Error(codes.InvalidArgument, err.Error())
	}
	...
	if err != nil {
		...
		return &npool.DeleteFractionWithdrawalRuleResponse{}, status.Error(codes.Internal, err.Error())
	}
