...
func (cq *CoinQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CoinQuery) FirstIDX(ctx context.Context) uint32 {
...
func (cq *CoinQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (cq *CoinQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (cq *CoinQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (cq *CoinQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CoinQuery) prepareQuery(ctx context.Context) error {
	...
	if coin.Policy == nil {
		return errors.New("ent: uninitialized coin.Policy (forgotten import ent/runtime?)")
	}
	if err := coin.Policy.EvalQuery(ctx, cq); err != nil {
		return err
	}
	return nil
}
