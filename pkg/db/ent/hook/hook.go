...
// The GoodUserFunc type is an adapter to allow the use of ordinary
// function as GoodUser mutator.
type GoodUserFunc func(context.Context, *ent.GoodUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GoodUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.GoodUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GoodUserMutation", m)
	}
	return f(ctx, mv)
}

// The OrderUserFunc type is an adapter to allow the use of ordinary
// function as OrderUser mutator.
type OrderUserFunc func(context.Context, *ent.OrderUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OrderUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
...
// The RootUserFunc type is an adapter to allow the use of ordinary
// function as RootUser mutator.
type RootUserFunc func(context.Context, *ent.RootUserMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RootUserFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.RootUserMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RootUserMutation", m)
	}
	return f(ctx, mv)
}
